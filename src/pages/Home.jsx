                ...
                <div className="container hero-inner">
                    <div className="hero-copy">
                        ...
                        <motion.h1 {...aoCarregar(0.2)}>
                            <span className="linha">Cuidado ginecológico </span>
                            <span className="linha">para <span className="destaque">cada fase</span> da vida </span>
                            <span className="linha destaque">da mulher.</span>
                        </motion.h1>
